...
public class ejercicio4 {
    ...
    public static int eraseOverlapIntervals(int[][] intervals) {
        ...
        int count = 1; // Contador de intervalos
    ...
    // ingreso  para leer intervalos desde el teclado
    ...
    // en esta parte se muestran los intervalos
    ...
    public static void main(String[] args) {
        ...
        while (continuar) {
            ...
            // mensaje que pregunta si desea continuar
            System.out.print("\n¿Desea procesar otros intervalos? (s/n): ");
            String respuesta = scanner.next();
            continuar = respuesta.equalsIgnoreCase("s");
        }

        System.out.println("¡Gracias por usar el Programa como ella te usó!");
        scanner.close();
    }
}
